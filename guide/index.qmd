...
::: {style="text-align: center; margin: 0.5em 0 1em;"}
![](images/clo-author-demo.gif){style="max-width: 40%; border-radius: 8px; border: 1px solid #00cc66; box-shadow: 0 0 15px rgba(0,204,102,0.3);" fig-alt="Clo-Author in action"}

*The legendary [Clodovil](https://en.wikipedia.org/wiki/Clodovil_Hernandes)*
:::
