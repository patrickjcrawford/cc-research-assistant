...
Run `/tools upgrade` inside your project. It:

1. Fetches the latest clo-author infrastructure from upstream
2. Replaces `.claude/` (agents, skills, rules, references, hooks)
3. Preserves your content (paper, scripts, data, bibliography)
4. Updates paths in CLAUDE.md to match your folder structure
5. Reports what changed and what needs manual attention
...
3. **Copy infrastructure:** replace `.claude/` and `templates/` with the 3.0 versions
4. **Keep your content:** don't rename folders that already have files
5. **Update CLAUDE.md:** adjust paths to match your actual layout
